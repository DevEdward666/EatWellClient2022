...
import PayMayaHeader from "./PayMayaHeader";
import PayMayaFooter from "./PayMayaFooter";
import PayMayaBody from "./PayMayaBody";
const PayMayaPaymentUI = () => {
...
export default PayMayaPaymentUI;
